...
4. Crie uma nova **branch** e nomeie como `feat/community/dev-cozeto`: `git checkout -b feat/community/dev-cozeto`;
...
4. Create a new **branch** and name it as `feat/community/dev-cozeto`: `git checkout -b feat/community/dev-cozeto`;
